      ...
      <div className="section-outer panel py-6 xl:py-9 bg-secondary dark:bg-gray-800">
        ...
        <div className="container max-w-lg">
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h2 mb-4">How GTL helps</h2>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                At Galactic Technologies (GTL), we don't just build websites and apps — we build solutions that solve real problems and help businesses grow. Whether you're a startup with a fresh idea or an established enterprise aiming to scale, GTL is your reliable tech partner.
              </p>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                With GTL, you're not just getting developers — you're getting a dedicated team that cares about your success.
              </p>
