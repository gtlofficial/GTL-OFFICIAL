          ...
          >
            <div className="vstack items-center gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-850px mx-auto text-center">
              ...
              <p className="fs-6 md:fs-5 text-dark dark:text-white text-opacity-70">
                Founded in 2015 by two passionate friends and visionary developers, Rahul Dhiman and Ritesh Dhiman, Galactic Technologies has grown into a trusted name in the world of digital solutions. With a shared dream to build powerful, user-friendly, and scalable technology, the duo laid the foundation of a company that today delivers cutting-edge digital services across the globe.
              </p>
            </div>
